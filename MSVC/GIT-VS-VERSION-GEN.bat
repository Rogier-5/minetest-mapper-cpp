::This file was taken at 17.01.2016 from https://github.com/Thell/git-vs-versioninfo-gen
::Added lines 165-167 to parse minetestmappers git tags
...
SET strFILE_VERSION=%strFILE_VERSION:~0,6%.%strFILE_VERSION:~6%
SET strFILE_VERSION=%strFILE_VERSION:~0,4%.%strFILE_VERSION:~4%
